...
navigator = {appCodeName: "Mozilla",
    appName: "Netscape",
    userAgent: "5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.0.0 Safari/537.36"
    }
...
document.cookie = 'ttcid=c045da7f7b994a0c96d58ab0028be0de26; s_v_web_id=verify_lgc085l8_GSNzKXBI_6G3a_4azw_8l45_fWXICDGCfgbG; _ga=GA1.1.1002402835.1681201938; local_city_cache=%E5%8C%97%E4%BA%AC; csrftoken=18bf4b4732ae25a0a72d786bcb11033b; _S_WIN_WH=1536_714; _S_DPR=1.25; _S_IPAD=0; _tea_utm_cache_24={%22utm_medium%22:%22wap_search%22}; passport_csrf_token=cc775159cedaa65421e5e65e8d194e69; _ga_QEHZPBE5HH=GS1.1.1683271585.5.1.1683272308.0.0.0; tt_scid=b5.SELiuFezYdvooeu-rtxOdeg-HXMqTBFVVM1n9oXvoRCjp1z.GhdGf3IAfakENcfa4'
function I(url ) {
    o = {url: url}
    a = {data: window.byted_acrawler.sign(o), cookie: document.cookie}
    return a
}
